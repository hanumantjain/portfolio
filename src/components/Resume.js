  ...
  return (
    <div id='resume'>
        ...
        <div className='flex flex-col gap-10 lg:m-10 justify-center items-center lg:flex-row '>
          <a target='_blank' href={resume} ><button className="h-12 text-white bg-gray-500 border-0 py-2 px-8 focus:outline-none hover:bg-gray-900 rounded text-lg mt-10" >
                      Resume
            </button></a>
